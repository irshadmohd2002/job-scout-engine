...
def test_default_watchlist_factory_returns_none_for_unimplemented_source() -> None:
    # lever_public_postings is no longer unimplemented as of Milestone 2
    # Deliverable 5 step 8 (decisions.md D-048) — see
    # test_lever_pipeline.py::test_lever_registered_in_default_watchlist_adapter_factory
    # for that coverage; this test now uses a placeholder source_id that
    # genuinely has no watchlist adapter.
    factory = _default_watchlist_adapter_factory(_limits())
